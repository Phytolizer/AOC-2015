...
static uint64_t ipow10[] = {1, 1e1, 1e2, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9, 1e10, 1e11, 1e12};
...
static int16_t ilog10(uint64_t x)
{
    ...
    static int16_t log10_estimates[] = {0, 0, 1, 1, 1, 2, 2, 2, 3, 3, 3, 4, 4, 4, 4,  5, 5,
...
int main(void)
{
    ...
    for (size_t i = 1; i < 10000000; ++i)
    {
        ...
        memcpy(key, input, inputLen); // NOLINT(bugprone-not-null-terminated-result)
